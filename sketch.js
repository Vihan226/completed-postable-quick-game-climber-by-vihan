...
function setup() {
  ...
  //height/2-109,100,5
  rect1=createSprite(width/1-width/2,height/2-120,150,5)
  rect1.visible=false
...
rect3=createSprite(width/1-width/2,height/2+80,150,5)
rect3.visible=false
...
climber.velocityX=-12
climber2.velocityX=13
 rect1.velocityX=-12
 rect3.velocityX=13
...
joker.velocityY = joker.velocityY + .8
...
if(score>1000){
  ...
  fill("red")
   ...
   joker.velocityY = joker.velocityY + .9
...
if(score>2000){
  ...
  fill("blue")
   ...
   joker.velocityY = joker.velocityY + 1
...
if(score>4000){
  ...
  fill("blue")
   ...
   ghost.visible=false
   joker.visible=true
   joker.velocityY = joker.velocityY + 1.1
   ghost.velocityY = ghost.velocityY + 1.1
}
if(score>5000){
  background(nightbg)
  textSize(50)
...
if(score>6000){
  ...
  fill("blue")
   ...
   joker.velocityY = joker.velocityY + 1.2
   ghost.velocityY = ghost.velocityY + 1.2
}
if(score>7000){
  background(nightbg)
  textSize(50)
...
if(score>8000){
  ...
  fill("blue")
   ...
   joker.velocityY = joker.velocityY + 1.3
...
if(score>9000){
  ...
  fill("red")
   ...
   joker.velocityY = joker.velocityY + 1.4
...
if(score>11000){
  ...
  fill("blue")
   ...
   joker.velocityY = joker.velocityY + 1.5
